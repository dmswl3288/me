    ...
    return (
        <PageLayout>
            <PageContainer id='work'>
                                        ...
                                        <div style={{ textAlign: 'left', marginTop: '25px' }}>
                                            ...
                                            <Typography component={'div'} sx={{ fontSize: '0.8rem' }}>
                                                ...
                                                {work.link && (
                                                    <div>
                                                        <br/>참고<br/>
                                                        <Link component='button' href='https://www.youtube.com/watch?v=sIoBtU8MuN4'>{work.link}</Link>
                                                    </div>
                                                )}
                                            </Typography>
                                        </div>
                ...
                <DetailWork handleClose={handleClose} open={open} title={selectedTitle} />
            </PageContainer>
        </PageLayout>
    )
}
